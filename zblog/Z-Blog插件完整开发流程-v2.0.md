...
当聊天中断、换新聊天或开发暂停后，用户只需要说“继续开发某插件”。
...
如果当前工具无法读取本机 Codex 工作树，仍需恢复 Notion 和 GitHub 可见状态，并将本机部分明确标记为“外部待执行”。
...
只有 Dry Run 通过后，才允许进入正式 Tag / Release / 部署阶段。
...
验收总分 30 分，27 分以上方可评为稳定；“状态真实性”“高风险保护”“中断恢复”任一为 0 分时，不得评为稳定。
